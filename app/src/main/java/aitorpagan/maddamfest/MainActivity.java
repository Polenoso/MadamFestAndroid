...
import aitorpagan.maddamfest.fragment.EventFragment;
import aitorpagan.maddamfest.fragment.MainFragment;
import aitorpagan.maddamfest.fragment.ShopFragment;
import aitorpagan.maddamfest.fragment.ShopListFragment;
...
public class MainActivity extends AppCompatActivity
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Log.e("OnClick",navigationView.getHeaderView(0).findViewById(R.id.imageView).toString());
    ...
    public boolean onNavigationItemSelected(MenuItem item) {
        ...
        if (id == R.id.nav_camera) {
            ...
            getSupportFragmentManager().beginTransaction().replace(R.id.mainFrame,shopFragment).commit();
